...
const mainRoutes = {
  ...
  children: [
    ...
    { path: '/curriculum-detail', component: _import('modules/tea/cur/curriculum-detail'), name: 'curriculum-detail', meta: { title: '审讯技术课程', isTab: true } },
    { path: '/personal-homepage', component: _import('modules/tea/my/personal-homepage'), name: 'personal-homepage', meta: { title: '我的', isTab: true } },
    { path: '/demo-echarts', component: _import('demo/echarts'), name: 'demo-echarts', meta: { title: 'demo-echarts', isTab: true } },
    { path: '/budding', component: _import('modules/tea/budding'), name: 'budding', meta: { title: '建设中', isTab: true } },
