<template>
  <div class="mod-config">
    ...
    <el-table :data="dataList" Error in callback for watcher "data": "Error: if there's nested data, rowKey is required."

found in border v-loading="dataListLoading" style="width: 100%;" highlight-current-row  @current-change="handleCurrentChange">
