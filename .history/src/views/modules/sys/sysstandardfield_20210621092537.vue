<template>
  <div class="mod-config">
    ...
    <el-table :data="dataList" border v-loading="dataListLoading" style="width: 100%;" highlight-current-row  @current-change="handleCurrentChange">
...
export default {
  ...
  methods: {
    ...
    getDataList () {
      ...
      this.$http({
        url: this.$http.adornUrl('//sysStandardField/list'),
        method: 'get',
    ...
    deleteHandle (id) {
      ...
      this.$confirm(
        ...
        this.$http({
          url: this.$http.adornUrl('//sysStandardField/delete'),
          method: 'post',
